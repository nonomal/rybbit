...
<div className="flex flex-col gap-2 my-6">
  <a href="#get-users" className="flex items-center gap-3 p-3 rounded-lg bg-fd-secondary/50 hover:bg-fd-secondary transition-colors no-underline">
    ...
    <code className="text-sm">/api/users/:site</code>
  </a>
  <a href="#get-user-sessions" className="flex items-center gap-3 p-3 rounded-lg bg-fd-secondary/50 hover:bg-fd-secondary transition-colors no-underline">
    <span className="px-2 py-1 text-xs font-bold rounded bg-green-500/20 text-green-600 dark:text-green-400">GET</span>
    <code className="text-sm">/api/users/:userId/sessions/:site</code>
  </a>
  <a href="#get-user-session-count" className="flex items-center gap-3 p-3 rounded-lg bg-fd-secondary/50 hover:bg-fd-secondary transition-colors no-underline">
    <span className="px-2 py-1 text-xs font-bold rounded bg-green-500/20 text-green-600 dark:text-green-400">GET</span>
    <code className="text-sm">/api/users/session-count/:site</code>
  </a>
  <a href="#get-user-info" className="flex items-center gap-3 p-3 rounded-lg bg-fd-secondary/50 hover:bg-fd-secondary transition-colors no-underline">
    <span className="px-2 py-1 text-xs font-bold rounded bg-green-500/20 text-green-600 dark:text-green-400">GET</span>
    <code className="text-sm">/api/users/:userId/:site</code>
  </a>
</div>
...
Accepts all [Common Parameters](/docs/api/stats/getting-started#common-parameters) plus the following:
...
Returns all sessions for a specific user, grouped with their pageviews. Useful for viewing a user's browsing history and behavior patterns.
...
Accepts all [Common Parameters](/docs/api/stats/getting-started#common-parameters) (time and filters).
...
<TypeTable
  type={{
    ...
    pageviews: {
      description: 'Array of pageviews in this session',
      type: 'Pageview[]',
    },
  }}
/>
...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X GET "https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31" \
  -H "Authorization: Bearer your_api_key_here"
```
  </Tab>
  <Tab value="JavaScript">
```javascript title="Request"
const response = await fetch(
  'https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31',
  {
    headers: {
      'Authorization': 'Bearer your_api_key_here'
    }
...
response = requests.get(
    'https://api.rybbit.io/api/users/abc123def456/sessions/123',
    params={
...
```php title="Request"
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer your_api_key_here'
]);
...
uri = URI('https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31')
req = Net::HTTP::Get.new(uri)
req['Authorization'] = 'Bearer your_api_key_here'
...
```
  ...
  <Tab value="Go">
```go title="Request"
req, _ := http.NewRequest("GET", "https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31", nil)
req.Header.Set("Authorization", "Bearer your_api_key_here")
...
let client = reqwest::Client::new();
let res = client
    .get("https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31")
    .header("Authorization", "Bearer your_api_key_here")
    .send()
    .await?;
...
HttpClient client = HttpClient.newHttpClient();
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31"))
    .header("Authorization", "Bearer your_api_key_here")
    .GET()
    .build();
...
var response = await client.GetAsync("https://api.rybbit.io/api/users/abc123def456/sessions/123?start_date=2024-01-01&end_date=2024-01-31");
var data = await response.Content.ReadAsStringAsync();
```
  </Tab>
</Tabs>
  ...
  "data": [
    {
      ...
      "device_type": "desktop",
      "country": "US",
      "firstTimestamp": "2024-01-31T14:00:00.000Z",
      "lastTimestamp": "2024-01-31T14:22:00.000Z",
      "duration": 1320,
      "pageviews": [
        {
          "pathname": "/pricing",
        ...
        },
        {
          ...
          "timestamp": "2024-01-31T14:10:00.000Z",
          "referrer": ""
        },
        {
          "pathname": "/",
