...
export function ThemeSwitcher() {
  ...
  if (!mounted) {
    return (
      <div className="bg-neutral-800 p-0.5 rounded-full w-[52px] h-[26px]" />
    );
  }
  ...
  return (
    <button
      ...
      className="bg-neutral-800 p-0.5 rounded-full flex items-center gap-0.5 transition-colors hover:bg-neutral-700"
